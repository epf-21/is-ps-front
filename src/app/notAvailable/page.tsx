    ...
    return(
        <div className="flex h-screen bg-gray-200">
            <div className="bg-white rounded-lg shadow-xl max-w-md m-auto">
                ...
                <h1 className="text-2xl font-bold text-gray-800 mb-6">Error.. Vehiculo No Disponible</h1>                    
                    ...
                    <p className="text-xl font-normal text-gray-600 mt-5 mb-6">Ups... lo sentimos, el auto que ha solicitado ya ha sido reservado/tomado. </p>                    
                    <hr />
